...
const ProductCard = ({productData}) => {
    return (
        <a className="w-[46%] h-[150px] flex justify-start border no-underline bg-[#fff]  mb-6 rounded-sm shadow transition-transform duration-100 ease-in will-change-transform
        hover:translate-y-[-1px] hover:shadow-[0_1px_20px_0_rgba(0,0,0,0.05)]" href="#">
            ...
            <div>
                ...
                <span className="flex ml-2  mb-1 text-[0.8rem]">{renderStarFromNumber(productData?.totalRating)}</span>
