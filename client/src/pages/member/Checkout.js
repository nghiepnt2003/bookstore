                        ...
                        <form className="mt-5 grid gap-6">
                            <div className="relative">
                                ...
                                <label 
                                    ...
                                    htmlFor="radio_1"
                                >
                                    <img className="w-14 object-contain" src="https://png.pngtree.com/png-clipart/20190925/original/pngtree-cartoon-hand-drawn-green-dollar-banknote-illustration-png-image_4887775.jpg" alt="Cash Payment" />
                                    <div className="ml-5">
                                        <span className="mt-2 font-semibold">Thanh toán bằng tiền mặt</span>
                                        <p className="text-slate-500 text-sm leading-6">Giao trong vòng: 2-4 ngày</p>
                                    </div>
                                </label>
                            </div>
                            <div className="relative">
                                ...
                                <label 
                                    ...
                                    htmlFor="radio_2"
                                >
                                    <img className="w-14 object-contain" src="https://developers.momo.vn/v3/vi/assets/images/square-8c08a00f550e40a2efafea4a005b1232.png" alt="MoMo Payment" />
                                    <div className="ml-5">
                                        <span className="mt-2 font-semibold">Thanh toán bằng MoMo</span>
                                    </div>
                                </label>
                            </div>
                            <div className='w-full mx-auto'>
