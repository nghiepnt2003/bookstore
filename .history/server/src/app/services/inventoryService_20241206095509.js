...
class InventoryService {
  ...
  async getInventoryByTime(startTime, endTime, queryParams) => {
    try {
      ...
      const excludeFields = ["sort", "fields", "page", "limit", "startTime", "endTime"];
      ...
      const totalCost = response.reduce((sum, inventory) => sum + inventory.totalCost, 0);
      ...
      return {
        ...
        message: response.length > 0 ? "Inventories fetched successfully." : "No inventories found.",
      };
    } catch (error) {
