...
class OrderService {
  ...
  async getOrdersByTimes(query) {
    ...
    // Format lại các operators cho mongoose
    ...
    const perPage = +limit || 10; // Mặc định là 10
    ...
    return { orders, totalAmount, counts };
  }
