...
class ProductService {
  ...
  async validateProductData (productData) {const { name, price, costPrice, pageNumber, author, publisher, categories } = productData;

  // Kiểm tra các trường bắt buộc
  if (!name || !price || !costPrice || !pageNumber || !author || !publisher || !categories) {
