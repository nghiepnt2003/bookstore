...
class CartController {
  ...
  // }
  {
    ...
    "cart": {
      ...
      "items": [
        {
          ...
          "product": {
            "_id": 2,
            "name": "Khi tài năng không theo kịp ước mơ",
            "price": 4.99,
            "discount": 10, // Tỷ lệ giảm giá
            "author": [{ "_id": 1, "name": "Nguyen Thanh Nghiep" }],
            "publisher": { "_id": 2, "name": "test publisher" },
            "categories": [{ "_id": 1, "name": "Action" }],
            "finalPrice": 4.491 // Giá sau khi áp dụng giảm giá
          },
          "quantity": 2,
          // Các thông tin khác...
        },
      ...
      "user": 7,
      "deleted": false,
      "createdAt": "2024-08-31T05:00:41.030Z",
      "updatedAt": "2024-10-11T02:39:03.446Z",
      "__v": 54
    }
  }
