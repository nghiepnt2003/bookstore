            ...
            <body>
                <div class="container">
                    <div class="content">
                        <h1>Book Store</h1>
                        <p>Xin chào!</p>
                        <p>Chúng tôi rất vui mừng thông báo rằng tài khoản của bạn tại Bookstore đã được đăng ký thành công! 🎉
                        Hân hạnh chào đón bạn gia nhập cộng đồng yêu sách tại cửa hàng trực tuyến của chúng tôi.🎉🎉🎉</p>
  ...
  async sendOTPCreateAccount(req, res, next) {
    try {
      ...
      if (user)
        return res
          .status(400)
          .json({ success: false, message: "User existing !!!" });
