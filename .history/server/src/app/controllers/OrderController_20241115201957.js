...
class OrderController {
  ...
  async callbackMomo(req, res) {
    ...
    const rawSignature = `accessKey=${req.body.accessKey}&amount=${amount}&orderId=${orderId}&orderInfo=${orderInfo}&partnerCode=${partnerCode}&requestId=${requestId}&resultCode=${resultCode}`;
