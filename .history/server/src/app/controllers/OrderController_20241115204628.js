...
class OrderController {
  ...
  async callbackMomo(req, res) {
    ...
    const rawSignature = `accessKey=${accessKey}&amount=${amount}&orderId=${orderId}&orderInfo=${orderInfo}&partnerCode=${partnerCode}&requestId=${requestId}&resultCode=${resultCode}`;
