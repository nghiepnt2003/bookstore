  ...
  async getProducts(req, res) {
    ...
    try {
      ...
      if (queries?.authorName) {
        ...
        // Nếu có tác giả tìm thấy, cập nhật điều kiện lọc
        if (authorIds.length > 0) {
          formatedQueries.author = { $in: authorIds }; // Sử dụng $in để lọc theo mảng
        } else {
          // Nếu không có tác giả nào được tìm thấy, trả về mảng rỗng
